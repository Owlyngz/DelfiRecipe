...
public class pageObjectTest {
    ...
    public void checkArticleTitle() {
        ...
        Assert.assertEquals("firstTest.Article title does not match", title, pageTitle);

        CommentPage commentPage = articlePage.openCommentPage();

        String commentPageTitle = commentPage.getTitle();
        Assert.assertTrue("firstTest.Article title does not match", commentPageTitle.contains(title));
    }
}
